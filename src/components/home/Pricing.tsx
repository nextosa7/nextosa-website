...
const plans = [
  {
    ...
    price: "$29",
    period: "/month",
    description: "For solo business owners getting started with NEXTOSA's business OS.",
    features: [
  ...
  },
  {
    ...
    price: "$79",
    period: "/month",
    description: "For growing teams that need full operations, staffing, and AI automation.",
    features: [
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "For larger, multi-location organizations with advanced compliance needs.",
    features: [
      "Unlimited staff & contacts",
